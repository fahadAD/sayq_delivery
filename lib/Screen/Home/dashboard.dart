...
class _DashBoardState extends State<DashBoard> {
              ...
              appBar: AppBar(
                ...
                title: ListTile(
                  ...
                  title: Text(
                    ...
                    style: kTextStyle.copyWith(color: kBgColor, fontSize: 17.0, fontWeight: FontWeight.bold),
                  ),
                  trailing: Container(
                                ...
                                Obx(
                                  () => dashboard.dashboardLoader.value
                                      ...
                                      : Container(
                                          ...
                                          child: dashboard.requestList.length == 0
                                              ? Center(
                                                  child: Text(
                                                  'no_item_found'.tr,
                                              ...
                                              : RefreshIndicator(
                                                  ...
                                                  child: ListView.builder(
                                                      itemCount: dashboard.requestList.length,
                                                      shrinkWrap: true,
                                                      padding: EdgeInsets.zero,
                                                      itemBuilder: (BuildContext context, int index) {
                                                        return InkWell(
                                                          onTap: () {
                                                            setState(() {
                                                              showPopUp(dashboard.requestList[index]);
                                                            });
                                                          },
                                                          child: Padding(
                                                                  ...
                                                                  Padding(
                                                                    ...
                                                                    child: Column(
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            SizedBox(
                                                                              width: 130.w,
                                                                              child: Text(
                                                                                dashboard.requestList[index].customerName.toString(),
                                                                                style: const TextStyle(
                                                                                  fontWeight: FontWeight.w500,
                                                                                  fontSize: 14,
                                                                                  color: nameColor,
                                                                            ...
                                                                            InkWell(
                                                                              onTap: () {
                                                                                Get.back();
                                                                                showPickupStatusPopUp(dashboard.requestList[index]);
                                                                              },
                                                                              child: SizedBox(
                                                                                height: 35.h,
                                                                                child: Card(
                                                                        ...
                                                                        Row(children: [
                                                                          Text(
                                                                            dashboard.requestList[index].customerPhone.toString(),
                                                                            style: const TextStyle(
                                                                          ...
                                                                          TextButton(
                                                                            onPressed: () => _launchURL(dashboard.requestList[index].customerPhone.toString()),
                                                                        ...
                                                                        Row(
                                                                          children: [
                                                                            SizedBox(
                                                                              width: 200.w,
                                                                              child: Text(
                                                                                dashboard.requestList[index].customerAddress.toString(),
                                                                                style: const TextStyle(
                                                                                  fontWeight: FontWeight.w400,
                                                                                  fontSize: 12,
                                                                                  color: hintColor,
                                                                            ...
                                                                            TextButton(
                                                                              onPressed: () {
                                                                                var url =
                                                                                    'https://www.google.com/maps/dir/?api=1&origin=&destination=${dashboard.requestList[index].customerAddress.toString()}&travelmode=driving';
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              '${Get.find<GlobalController>().currency!}${dashboard.requestList[index].cashCollection.toString()}',
                                                                              style: const TextStyle(
                                                                                fontWeight: FontWeight.w400,
                                                                                fontSize: 12,
                                                                                color: hintColor,
                                                                            ...
                                                                            Text(
                                                                              dashboard.requestList[index].priorityTypeId.toString() == '1' ? 'High' : 'Normal',
                                                                              style: const TextStyle(
                                                                                fontWeight: FontWeight.w600,
                                                                                fontSize: 13,
                                                                                color: Colors.red,
  ...
  void showPopUp(ParcelModel parcel) {
    showDialog(
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 5.0),
                    parcel.note == null
                        ? Center(child: Text("You have no note"))
                        : Column(
                            children: [
                              Row(
                                children: [
  ...
  void showStatusPopUp(ParcelModel parcel) {
    showDialog(
        barrierDismissible: true,
        context: context,
        builder: (BuildContext context) {
  ...
  void showPickupStatusPopUp(ParcelModel parcel) {
                            ...
                            onPressed: () async {
                              ...
                              if (form!.validate()) {
                                ...
                                dashboardController.changeStatusWithOutSignature(
                                  context: context,
                                  statusID: dashboardController.collectStatusID,
